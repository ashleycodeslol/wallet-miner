# everything here is fake and doesnt do anything. uses 2-3% of gpu and no cpu usage.
# dont try to sell this, because i will find you.
...
def print_slow(str):
    for letter in str:
        sys.stdout.write(letter)         #not used
        sys.stdout.flush()
        time.sleep(0.00001)
#-----------------------------------------
...
tt = input("'btc'/'eth'/'both'\n>")       # asking for the crypto wallet type to mine
...
if t == "btc":
	...
	coin_co =  "Ethereum"
	short_co = "0.0000 ETH"          # differnt cypto to select from
	false_co = "ETH"
elif t == "both":
	coin_co = "Both"
...
print(ban2)
key = input(">")       # 'key' var is not used.                                              
print("\nWallet not valid, proceeding in key only mode.")          # it doesnt actually check if the wallet is real (suprise)
time.sleep(3)
os.system('cls')
...
print(col_ur  + "▒█░ █ ░█ ▒██  ▀█▄  ▒██░    ▒██░    ▒███  ▒ ▓██░ ▒░" + col_ur2 + " ▓██    ▓██░▒██▒▓██  ▀█ ██▒▒███   ▓██ ░▄█ ▒")
print(col_ur  + "░█░ █ ░█ ░██▄▄▄▄██ ▒██░    ▒██░    ▒▓█  ▄░ ▓██▓ ░ " + col_ur2 + " ▒██    ▒██ ░██░▓██▒  ▐▌██▒▒▓█  ▄ ▒██▀▀█▄  ")
print(col_ur  + "░░██▒██▓  ▓█   ▓██▒░██████▒░██████▒░▒████▒ ▒██▒ ░ " + col_ur2 + " ▒██▒   ░██▒░██░▒██░   ▓██░░▒████▒░██▓ ▒██▒")         # another banner
print(col_ur  + "░ ▓░▒ ▒   ▒▒   ▓▒█░░ ▒░▓  ░░ ▒░▓  ░░░ ▒░ ░ ▒ ░░   " + col_ur2 + " ░ ▒░   ░  ░░▓  ░ ▒░   ▒ ▒ ░░ ▒░ ░░ ▒▓ ░▒▓░")
print(col_ur  + "  ▒ ░ ░    ▒   ▒▒ ░░ ░ ▒  ░░ ░ ▒  ░ ░ ░  ░   ░    " + col_ur2 + " ░  ░      ░ ▒ ░░ ░░   ░ ▒░ ░ ░  ░  ░▒ ░ ▒░")
print(col_ur  + "  ░   ░    ░   ▒     ░ ░     ░ ░      ░    ░      " + col_ur2 + " ░      ░    ▒ ░   ░   ░ ░    ░     ░░   ░ ")
print(col_ur  + "    ░          ░  ░    ░  ░    ░  ░   ░  ░        " + col_ur2 + "         ░    ░           ░    ░  ░   ░    ")
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
time.sleep(1.25)
for en in range(1, (random.randint(2000000, 20000000))):      # randomness of finding a wallet, its 2 million and 20 million.
	print(col_ur  + coin_co + col_ur2 +" |0x"+g(52) + "| " + col_ur + short_co + "  (INVALID)")
	time.sleep(0.01)
#-------------------------------------------------------------------------------------------------------------------------------
dawg = ['13vha36jMwcxzLvogef1QKdyHUsnwSrSyi', '1KYGfzr2RrvbT3wjtnWhksUcrPtatZgki6', '16r1hJDrXgHcZWymwFpaLrriqRzxqUA8Vm',
	'1MFxWN1fvMicg8XFZaEr5EkEs4qWZb59bp', '1BRf6HNxL5riFCuCeYJ3wuSyjjWeLynHQQ']                                    #'dawg' is random public keys
derg = ['L3TFkGWsVnherhkq6Qy9j3kr1TjCZzbn1u4sWa3Jag9dBDTsCnCh', 'KxnYWCXyqaArve6hiQ4e3igN6RUbWsSEA1MmWMXip21JCVYoCjt4',
	'L5GTYtR2zWvtA6T8jNe9XtnXNHcYMDBGeXMAaPUQ84dnNYRAxLFW']                                                        #'derg' is random private keys (not used)
...
print("The public address is;" + col_ur + " " + (random.choice(dawg)))              # saying that the program has found a wallet, containing nothing
while True: pass
